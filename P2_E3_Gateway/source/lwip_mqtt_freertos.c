...
static const struct mqtt_connect_client_info_t mqtt_client_info = {
    ...
    .client_user = "DavidFloresRuiz",
    .client_pass = "aio_NdtR61qmyyTaQwhKBLkCgFK8eIr0",
    .keep_alive  = 100,
    .will_topic  = NULL,
    .will_msg    = NULL,
    .will_qos    = 0,
...
{
    static const char *topics[] = {"DavidFloresRuiz/feeds/feedtopic"};
    int qos[]                   = {0};
    err_t err;
    int i;
...
{
    static const char *topic1   = "DavidFloresRuiz/feeds/p2-texto1";
    static const char *message1 = "Hello 2";

    static const char *topic2   = "DavidFloresRuiz/feeds/p2-keepalive";
    static const char *message2 = "1";	// "1" prende
    static const char *message3 = "0";	// "0" apaga

    if(g_KeepAlive == 0xa000000){
...
//        	g_KeepAlive = rxFrame.dataWord0>>28;
        	// Hacer mascaras logicas cada 8 bits
