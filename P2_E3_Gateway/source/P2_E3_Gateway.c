 ...
 *	 -Envía:
 *	 	*KA cada 5s
 *	 	*Niveles de batería registrados cada 30s
 *
 *	 En módulo:
 *	  -Guarda:
 *	  	*Muestras recibidas del nivel de batería durante 30s(el número de muestras depende de la
 *	  	frecuencia decidida por el broker - 6, 3 o 2 muestras)
 *	  -FIFO para mandar el registro al broker
*/
/*
